...
const ChatInterfaceDialog: React.FC<TooltipRenderProps> = ({
    ...
    return (
        ...
        isMobile ? (
            ...
            <Card className="relative flex w-full max-w-lg overflow-visible bg-white/90 rounded-3xl pl-0 pr-0 pt-0 pb-0 bg-gradient-to-r from-pink-200 via-pink-200 to-white border-0 border-b-4 border-rose-600 shadow-2xl">
