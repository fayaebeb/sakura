    ...
    <div className="relative overflow-visible flex">
      <div ref={buttonGroupRef} className="flex">
        ...
        <button
          ...
          className={`h-[40px] px-2 py-2 rounded-r-full shadow-md border-l-0 transition-all border ${
            useDb
          ...
          >
            {searchModes.map((item) => (
              <button
                ...
                className={`flex flex-col items-start w-full px-3 py-2 text-sm rounded-md transition text-left ${
